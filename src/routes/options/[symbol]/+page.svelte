<script lang="ts">
	...
	import OptionsChain from '../../../components/OptionsChain.svelte';
	import StrategyCard from '../../../components/StrategyCard.svelte';
	import OptionGlossary from '../../../components/OptionGlossary.svelte';
			...
			<div class="text-right">
				...
				<p class="data" style="color: var(--foreground); font-size: 1.1rem">
					...
					{#if dayChangePct !== null}
						<span class="data" style="color: {dayChangePct >= 0 ? '#16a34a' : '#dc2626'}; font-size: 0.8rem">
			...
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
				...
				<div>
					...
					{#if targetMovePct !== null}
						<p class="label mt-2" style="color: {targetMovePct >= 0 ? '#16a34a' : '#dc2626'}; text-transform: none">
